...
#ifdef _MSC_VER
        "<p style=\"margin-bottom:8px; margin-top:1px; \">" + AboutDlgImpl::tr("Build with %1 and using %2 libraries").arg("<a href=\"https://visualstudio.microsoft.com/vs/community/\">Visual Studio Community</a>").arg("<a href=\"https://learn.microsoft.com/en-us/cpp/windows/latest-supported-vc-redist\">Microsoft Visual C++ Redistributable</a>") + "</p>"
#endif
