...
public:
    ...
    DECL_NOTE_INFO(id3v2ProgressiveJpeg, WARNING, APIC, QT_TR_NOOP("Found image encoded as progressive JPEG. Some players might be incompatible with it."), true) // k
    ...
    DECL_NOTE_INFO(id3v230NegativeFrameSize, ERR, ID3V230, QT_TR_NOOP("Invalid ID3V2.3.0 frame. Frame size is negative."), true) // h
    DECL_NOTE_INFO(id3v230FrameTooLong, ERR, ID3V230, QT_TR_NOOP("Invalid ID3V2.3.0 frame. Maximum supported size is 64 MB."), true) // i
    DECL_NOTE_INFO(id3v230LargeFrame, WARNING, ID3V230, QT_TR_NOOP("ID3V2.3.0 frame is larger than usual, possibly wasting space."), true) // j
